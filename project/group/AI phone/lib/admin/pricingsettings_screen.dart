                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: ElevatedButton(
                        // Inside the ElevatedButton onPressed in PricingScreen.dart
                        onPressed: () async {
                          String newCurrency = _currencyController.text.isEmpty ? "RM" : _currencyController.text;
                          ...
                          try {
                            ...
                            // Update local service as well so it reflects immediately
                            ...
                            if (context.mounted) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(content: Text('Currency updated in Database!'), backgroundColor: Colors.green),
                              );
